import unittest
from parameterized from parameterized
...
class HangmanTests(unittest.TestCase):
    ...
    def test_get_all_index_should_return_two_and_three_l_in_word_hello(self):
        # Given
        text = 'l'
        word = 'hello'
        expected = [2,3]
    ...
    def test_get_all_index_should_raise_value_error_if_text_is_longer_then_ab(self):
        # Given
        text = 'ab'
        word = 'hello'
        # When Then
